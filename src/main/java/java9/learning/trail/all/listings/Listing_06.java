...
public class Listing_06 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Values greater than four: %s%n", Arrays.stream(values).filter(value -> value > 4).sorted().collect(Collectors.toList()));

        System.out.printf("Values greater than four (ascending with streams): %s%n", greaterThan4.stream().sorted().collect(Collectors.toList()));
